        ...
        <div className="container">
          ...
          >
            ...
            <motion.h1 variants={titleVariants}>
              <span className="gradient-text">Website & App Development</span>
            </motion.h1>
            <motion.h2 variants={itemVariants} className="hero-subtitle">Digital Solutions That Drive Growth</motion.h2>
            <motion.p variants={itemVariants} className="hero-description">
              Custom, high-performance websites and mobile applications built with modern technologies for exceptional user experiences.
            </motion.p>
        ...
        <div className="container">
          <div className="service-content-grid">
            <motion.div
              ...
              variants={containerVariants}
            >
              <motion.h2 variants={titleVariants}>Build Your Digital Presence</motion.h2>
              <motion.p variants={itemVariants}>
                We create stunning, functional websites and applications that not only
                look great but also deliver outstanding performance and user experiences.
                Our development process focuses on clean code, scalability, and maintainability.
              </motion.p>
              <motion.p variants={itemVariants}>
                From simple landing pages to complex enterprise applications, we have
                the expertise to bring your digital vision to life.
              </motion.p>
            ...
            >
              ...
              <p>
                Let's discuss your website or app idea and create a custom solution
      ...
      <section className="why-choose-us-section">
        <div className="container">
          ...
          >
            ...
            <p>Let's create a stunning, high-performance website or app that drives results for your business.</p>
            <div className="cta-buttons">
              <Link to="/contact" className="btn btn-primary">
                <i className="fas fa-calendar-check"></i> Get a Quote
              </Link>
              <Link to="/work" className="btn btn-secondary">
                <i className="fas fa-play-circle"></i> See Our Work
              </Link>
