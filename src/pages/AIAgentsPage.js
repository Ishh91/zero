          ...
          >
            <motion.div variants={itemVariants}>
              <div className="hero-badge">
                <i className="fas fa-robot"></i> AI & AI Agents
              </div>
            </motion.div>
            <motion.h1 variants={titleVariants}>
              <span className="gradient-text">AI & AI Agents</span>
            </motion.h1>
            <motion.h2 variants={itemVariants} className="hero-subtitle">Intelligent Automation That Works For You</motion.h2>
            <motion.p variants={itemVariants} className="hero-description">
              Harness the power of artificial intelligence to automate your business processes and create intelligent, self-operating systems.
            </motion.p>
        ...
        <div className="container">
          <div className="service-content-grid">
            <motion.div
              ...
              variants={containerVariants}
            >
              <motion.h2 variants={titleVariants}>Intelligence at Work</motion.h2>
              <motion.p variants={itemVariants}>
                Our AI and AI Agents solutions help businesses leverage the latest
                advancements in artificial intelligence to automate tasks, improve
                efficiency, and unlock new possibilities.
              </motion.p>
              <motion.p variants={itemVariants}>
                From customer service chatbots to fully autonomous AI agents, we
                build intelligent systems that work for you 24/7.
              </motion.p>
            ...
            >
              ...
              <p>
                Let's explore how AI can transform your operations and give you
      ...
      <section className="why-choose-us-section">
        <div className="container">
          ...
          >
            ...
            <p>Let's build intelligent automation systems that take your business to the next level.</p>
