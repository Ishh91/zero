    ...
    <div className="service-detail-page">
          ...
          >
            <motion.div variants={itemVariants}>
              <div className="hero-badge">
                <i className="fas fa-rocket"></i> Startup Foundation
              </div>
            </motion.div>
            <motion.h1 variants={titleVariants}>
              <span className="gradient-text">Startup Foundation</span>
            </motion.h1>
            <motion.h2 variants={itemVariants} className="hero-subtitle">Build Your Dream, the Right Way</motion.h2>
            <motion.p variants={itemVariants} className="hero-description">
              Launch your startup with confidence — from incorporation to business planning and everything in between.
            </motion.p>
        ...
        <div className="container">
          <div className="service-content-grid">
            <motion.div
              ...
              variants={containerVariants}
            >
              <motion.h2 variants={titleVariants}>Build Your Dream, the Right Way</motion.h2>
              <motion.p variants={itemVariants}>
                Starting a business can be overwhelming. Our Startup Foundation service
                provides everything you need to launch successfully, from legal setup
                to strategic planning.
              </motion.p>
              <motion.p variants={itemVariants}>
                We guide you through every step of the startup journey, ensuring you
            ...
            >
              ...
              <p>
                Let's turn your business idea into reality with our comprehensive
      ...
      <section className="why-choose-us-section">
        <div className="container">
          ...
          >
            <h3>Ready to Launch Your Dream Startup?</h3>
            <p>Let's build a solid foundation for your business and set you up for long-term success.</p>
...
export default StartupFoundationPage;
